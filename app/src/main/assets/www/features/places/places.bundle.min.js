...
$scope.isUserCentered=!0;Location.getLocation().then(function(position){$scope.crMap.setCenter(new google.maps.LatLng(position.coords.latitude,position.coords.longitude));$scope.crMap.setZoom(Places.settings.defaultCenterZoom||8)},function(){if(startup===undefined){Dialog.alert('Location','Sorry we are unable to locate you, please check your GPS settings & authorization.','OK',-1,'Places')}})};$scope.updateBounds=function(){var jsonBounds=$scope.crMap.getBounds().toJSON();$scope.filters.e=jsonBounds.east;$scope.filters.n=jsonBounds.north;$scope.filters.s=jsonBounds.south;$scope.filters.w=jsonBounds.west;$scope.filters.zoom=$scope.crMap.getZoom()};$scope.initMap=function(){var lat=43.604652;var lng=1.444209;if(Places.settings.hasOwnProperty('lat')&&Places.settings.hasOwnProperty('lng')){lat=parseFloat(Places.settings.lat);lng=parseFloat(Places.settings.lng)}
