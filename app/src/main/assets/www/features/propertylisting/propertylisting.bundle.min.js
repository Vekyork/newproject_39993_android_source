...
if(_.includes(_.get(adco,"types")||[],"country")){$scope.edit_listing_value.country=_.get(adco,"short_name")}})}}}});angular.module('starter').controller('PropertylistingAccountController',function($state,$ionicHistory,$ionicScrollDelegate,$ionicHistory,Location,$ionicActionSheet,$timeout,$ionicSlideBoxDelegate,$stateParams,$scope,$rootScope,$translate,Propertylisting,Customer,Loader,Dialog,$filter,$ionicModal,GoogleMaps){$scope.value_id=Propertylisting.value_id=$stateParams.value_id;$scope.payload=[];$scope.is_loading=!1;$scope.is_logged_in=Customer.isLoggedIn();$scope.customer=Customer.customer;$scope.settings=Propertylisting.getListingSettings();$scope.myAccount=function(){Customer.loginModal($scope,function(){Loader.show();$timeout(function(){$scope.is_logged_in=Customer.isLoggedIn();$scope.customer=Customer.customer;$state.go('home').then(function(){$state.go("propertylisting-home",{value_id:$scope.value_id},{reload:!0}).then(function(){Loader.hide();$state.go("propertylisting-account",{value_id:$scope.value_id},{reload:!0})})})},1000)})}
$scope.loadContent=function(){if(!Customer.isLoggedIn()){return Customer.loginModal($scope)}
$scope.is_loading=!0;Loader.show();Propertylisting.findMyAccount().success(function(data){$scope.payload=data;$scope.settings=data.settings;$scope.is_loading=!1;Loader.hide()}).error(function(error){$scope.is_loading=!1;Loader.hide();Dialog.alert($translate.instant("Error","propertylisting"),error.message,"OK",-1,"propertylisting")}).finally(function(){})}
$scope.loadContent()});angular.module('starter').controller('PropertylistingFavoriteController',function($controller,Application,$state,$ionicScrollDelegate,$ionicActionSheet,$timeout,$ionicSlideBoxDelegate,$stateParams,$scope,$rootScope,$translate,Propertylisting,Customer,Loader,Dialog,$filter,$ionicModal){angular.extend(this,$controller('PropertylistingInitController',{$ionicModal:$ionicModal,Dialog:Dialog,$rootScope:$rootScope,$scope:$scope,$stateParams:$stateParams,Propertylisting:Propertylisting}));$scope.value_id=Propertylisting.value_id=$stateParams.value_id;$scope.favoriteCollection=[];$scope.is_loading=!1;$scope.listing_settings=Propertylisting.getListingSettings();$scope.loadContent=function(){if(!Customer.isLoggedIn()){return Customer.loginModal($scope)}
$scope.is_loading=!0;Loader.show();Propertylisting.findFavorite().success(function(data){$scope.favoriteCollection=data.collection;$scope.is_loading=!1;Loader.hide()}).error(function(error){$scope.is_loading=!1;Loader.hide();Dialog.alert($translate.instant("Error","propertylisting"),error.message,"OK",-1,"propertylisting")}).finally(function(){})}
$scope.loadContent()});angular.module('starter').controller('PropertylistingHistoryController',function($controller,Application,$state,$ionicScrollDelegate,$ionicActionSheet,$timeout,$ionicSlideBoxDelegate,$stateParams,$scope,$rootScope,$translate,Propertylisting,Customer,Loader,Dialog,$filter,$ionicModal){angular.extend(this,$controller('PropertylistingInitController',{$ionicModal:$ionicModal,Dialog:Dialog,$rootScope:$rootScope,$scope:$scope,$stateParams:$stateParams,Propertylisting:Propertylisting}));$scope.value_id=Propertylisting.value_id=$stateParams.value_id;$scope.historyCollection=[];$scope.is_loading=!1;$scope.listing_settings=Propertylisting.getListingSettings();$scope.loadContent=function(){if(!Customer.isLoggedIn()){return Customer.loginModal($scope)}
$scope.is_loading=!0;Loader.show();Propertylisting.findHistory().success(function(data){$scope.historyCollection=data.collection;$scope.is_loading=!1;Loader.hide()}).error(function(error){$scope.is_loading=!1;Loader.hide();Dialog.alert($translate.instant("Error","propertylisting"),error.message,"OK",-1,"propertylisting")}).finally(function(){})}
$scope.loadContent()});angular.module('starter').controller('PropertylistingMessagesController',function($controller,Application,$state,$ionicScrollDelegate,$ionicActionSheet,$timeout,$ionicSlideBoxDelegate,$stateParams,$scope,$rootScope,$translate,Propertylisting,Customer,Loader,Dialog,$filter,$ionicModal){angular.extend(this,$controller('PropertylistingInitController',{$ionicModal:$ionicModal,Dialog:Dialog,$rootScope:$rootScope,$scope:$scope,$stateParams:$stateParams,Propertylisting:Propertylisting}));$scope.value_id=Propertylisting.value_id=$stateParams.value_id;$scope.messagesCollection=[];$scope.is_loading=!1;$scope.listing_settings=Propertylisting.getListingSettings();$scope.loadContent=function(){if(!Customer.isLoggedIn()){return Customer.loginModal($scope)}
$scope.is_loading=!0;Loader.show();Propertylisting.findMessages().success(function(data){$scope.messagesCollection=data.messages;$scope.is_loading=!1;Loader.hide()}).error(function(error){$scope.is_loading=!1;Loader.hide();Dialog.alert($translate.instant("Error","propertylisting"),error.message,"OK",-1,"propertylisting")}).finally(function(){})}
$scope.loadContent();$scope.messageCustomerName=function(value){if(value.sender_customer_id==Customer.id){if(value.receiver_customer_id!=''&&value.receiver_customer_id!=null){return value.receiver_first_name+' '+value.receiver_last_name}else{return $scope.listingFavoriteData.app_name}}else{return value.sender_first_name+' '+value.sender_last_name}}
$scope.messageCustomerImage=function(value){if(value.sender_customer_id==Customer.id){if(value.receiver_customer_id!=''&&value.receiver_customer_id!=null){if(value.receiver_image!=''&&value.receiver_image!=null&&value.receiver_image!="null"){return IMAGE_URL+'images/customer'+value.receiver_image}else{return"./features/propertylisting/assets/media/customer-placeholder.png"}}else{return IMAGE_URL+$scope.listingFavoriteData.app_image}}else{if(value.sender_image!=''&&value.sender_image!=null&&value.sender_image!="null"){return IMAGE_URL+'images/customer'+value.sender_image}else{return"./features/propertylisting/assets/media/customer-placeholder.png"}}}});angular.module('starter').controller('PropertylistingMapController',function($controller,$state,$ionicScrollDelegate,Location,$ionicActionSheet,$timeout,$ionicSlideBoxDelegate,$stateParams,$scope,$rootScope,$translate,Propertylisting,Customer,Loader,Dialog,$filter,$ionicModal,GoogleMaps){angular.extend(this,$controller('PropertylistingInitController',{$ionicModal:$ionicModal,Dialog:Dialog,$rootScope:$rootScope,$scope:$scope,$stateParams:$stateParams,Propertylisting:Propertylisting}));$scope.value_id=Propertylisting.value_id=$stateParams.value_id;$scope.filter=Propertylisting.filter
...
$scope.range=function(min,max,step){step=step||1;var input=[];for(var i=min;i<=max;i+=step)input.push(i);return input}});angular.module('starter').controller('PropertylistingPlansController',function($controller,Application,$state,$ionicScrollDelegate,$ionicActionSheet,$timeout,$ionicSlideBoxDelegate,$stateParams,$scope,$rootScope,$translate,Propertylisting,Customer,Loader,Dialog,$filter,$ionicModal){$scope.value_id=Propertylisting.value_id=$stateParams.value_id;$scope.payout=[];$scope.is_loading=!1;$scope.settings=Propertylisting.getListingSettings();$scope.loadContent=function(){$scope.is_loading=!0;Loader.show();Propertylisting.findPlans().success(function(data){$scope.payout=data;$scope.is_loading=!1;Loader.hide()}).error(function(error){$scope.is_loading=!1;Loader.hide();Dialog.alert($translate.instant("Error","propertylisting"),error.message,"OK",-1,"propertylisting")}).finally(function(){})}
$scope.loadContent();$scope.planImages=function(image){if(image!=''&&image!=null&&image!="null"){return IMAGE_URL+'images/application'+image}else{return"./features/propertylisting/assets/media/no_image.jpg"}};$scope.getMembership=function(value){Propertylisting.cart=value;$state.go("propertylisting-checkout",{value_id:$scope.value_id},{reload:!0})}}).controller('PropertylistingCheckoutController',function($controller,Application,$state,$ionicScrollDelegate,$ionicActionSheet,$timeout,$ionicSlideBoxDelegate,$stateParams,$scope,$rootScope,$translate,Propertylisting,Customer,Loader,Dialog,$filter,$ionicModal){$scope.value_id=Propertylisting.value_id=$stateParams.value_id;$scope.payout=[];$scope.is_loading=!1;$scope.settings=Propertylisting.getListingSettings();$scope.cart=Propertylisting.cart;$scope.cart.payment_method='NA';$scope.choosePaymentMethod=function(method){$scope.cart.payment_method=method;console.log($scope.cart)}
$scope.saveAndProceed=function(){console.log($scope.cart);Loader.show();Propertylisting.saveOrder($scope.cart).success(function(data){Loader.hide();if(data.payment_method=='wallet'){$state.go("propertylisting-ewallet",{value_id:$scope.value_id,order_id:data.order_id},{reload:!0})}else{Dialog.alert($translate.instant("Success","propertylisting"),data.cod_messages,$translate.instant("OK","propertylisting"),-1,"propertylisting");$state.go("home",{value_id:$scope.value_id},{reload:!0}).then(function(){$state.go("propertylisting-home",{value_id:$scope.value_id},{reload:!0})})}}).error(function(error){Loader.hide();Dialog.alert($translate.instant("Error","propertylisting"),error.message,"OK",-1,"propertylisting")}).finally(function(){})}});angular.module('starter').controller('PropertylistingEwalletController',function(Dialog,Loader,Customer,$filter,Modal,$ionicPopup,$ionicScrollDelegate,$timeout,$ionicHistory,$rootScope,SB,Propertylisting,$scope,$state,$stateParams,$translate,Ewallet,$ionicHistory,$ionicSideMenuDelegate){$scope.value_id=Propertylisting.value_id=$stateParams.value_id;$scope.order_id=$stateParams.order_id;$scope.is_loading=!1;$scope.loadContent=function(){$scope.cart={};Loader.show();Propertylisting.findByTransactionId($scope.order_id).then(function(data){$scope.payout=data;$scope.cart.method=='payToModule';$scope.cart.order_id=$scope.order_id;$scope.cart.amount=data.order.total_amount;$scope.cart.currency_code=data.order.currency;$scope.cart.currency_symbol=data.order.currency;$scope.cart.remark="Order #"+$scope.order_id;$scope.cart.return_state_name='propertylisting-ewallet-return';$scope.cart.return_value_id=$scope.value_id;Ewallet.setPaycart($scope.cart);$ionicHistory.nextViewOptions({disableBack:!0});$ionicSideMenuDelegate.canDragContent(!1);$state.go("ewallet-module-payment",{value_id:data.ewallet_value_id},{reload:!0});Loader.hide()},function(error){Dialog.alert($translate.instant("Error","eventpro"),error.message,$translate.instant("Ok","eventpro"),-1,'eventpro')}).then(function(){$scope.is_loading=!1})}
$scope.loadContent()}).controller('PropertylistingEwalletReturnController',function(Dialog,Loader,Customer,$filter,Modal,$ionicPopup,$ionicScrollDelegate,$timeout,$ionicHistory,$rootScope,SB,Propertylisting,$scope,$state,$stateParams,$translate,Ewallet,$ionicHistory,$ionicSideMenuDelegate){$scope.value_id=Propertylisting.value_id=$stateParams.value_id;$scope.cart=Ewallet.getPaycart();console.log($scope.cart);$ionicHistory.nextViewOptions({historyRoot:!0,disableAnimate:!1,disableBack:!0});$ionicSideMenuDelegate.canDragContent(!0);Loader.show();Propertylisting.updatePaymentStatus($scope.cart).then(function(data){Loader.hide();if($scope.cart.status=='success'){Dialog.alert($translate.instant("Error","propertylisting"),$translate.instant("Payment has been successfully","propertylisting"),$translate.instant("OK","propertylisting"),-1,"propertylisting")}
if($scope.cart.status=='failed'){Dialog.alert($translate.instant("Error","propertylisting"),$translate.instant("Payment has been failed","propertylisting"),$translate.instant("OK","propertylisting"),-1,"propertylisting")}
Ewallet.setPaycart({});$state.go("home",{value_id:$scope.value_id},{reload:!0}).then(function(){$state.go("propertylisting-home",{value_id:$scope.value_id},{reload:!0})})},function(error){Loader.hide();Dialog.alert($translate.instant("Error","propertylisting"),error.message,$translate.instant("OK","propertylisting"),-1,"propertylisting")})});angular.module('starter').factory('Propertylisting',function($pwaRequest,Customer,$sbhttp,Url,Application,Pages){var factory={};factory.value_id=null;factory.settings=[];factory.filter={};factory.cart={};factory.listings=[];factory.setValueId=function(valueId){factory.value_id=valueId;return factory};factory.getValueId=function(){return factory.value_id};factory.setListingSettings=function(settings){factory.settings=settings;return factory};factory.getListingSettings=function(){return factory.settings};factory.setaddpropertyValue=function(addproperty){factory.addproperty=addproperty;return factory};factory.getaddpropertyValue=function(){return factory.addproperty};factory.setListingFilter=function(filter){factory.filter=filter;return factory};factory.getListingFilter=function(){return factory.filter};factory.setListings=function(listings){factory.listings=listings;return factory};factory.getListings=function(){return factory.listings};factory.setPropertytype=function(type){factory.type=type;return factory};factory.getPropertytype=function(){return factory.type};factory.setPropertyFieldLabel=function(label){factory.label=label;return factory};factory.getPropertyFieldLabel=function(){return factory.label};factory.onStart=function(){Application.loaded.then(function(){var propertylisting=_.find(Pages.getActivePages(),{code:'propertylisting'});if(!propertylisting){return}
